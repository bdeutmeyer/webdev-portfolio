...
export default function About() {
    return (
        <>
            ...
            <p className="text-start">I have spent over 15 years building a successful career as a voice teacher. I maintain a private studio at home, and have also taught at a few area high schools, colleges, and universities. I hope that my career journey will allow me to marry up my teaching skills with my new tech chops. Working to help people navigate this complex ecosystem and learn new and better ways to achieve their goals sounds incredibly rewarding. No matter what else the future holds for me, I intend to keep building cool sites, solving problems, untangling puzzles, and growing in my knowledge!</p>            
        </>
    );
};